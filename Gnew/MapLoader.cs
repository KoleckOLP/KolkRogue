...
namespace Gnew
{
    ...
    {
        (char[][] map, Player player) LoadMap(bool custom = false, string levelName = "G2_lvl1");
    }

    public class MapLoader : IMapLoaderService
    {
        public (char[][] map, Player player) LoadMap(bool custom = false, string levelName = "G2_lvl1")
        {
            if (custom)
            {
